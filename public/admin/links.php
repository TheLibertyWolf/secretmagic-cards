...
<td><?= cards_h(ucfirst($link['rank_value'])) ?> · <?= cards_h($link['suit']) ?><small><?= cards_h(cards_style_label($pdo, $link['visual_style'])) ?></small></td><td><strong><?= (int)$link['visit_count'] ?></strong></td><td><?= $link['max_visits']===null?'∞':(int)$link['max_visits'] ?></td>
